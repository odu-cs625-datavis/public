...
**Due:** Tuesday, February 01, 2022 by 11:59pm 
...
Submit the URL of your report (*not the URL of your repo*) in Blackboard. Make sure that you have committed and pushed your local repo to GitHub.  Include "Ready to grade @Faryaneh" in your final commit message. 

* Click on HW2 under Week 2 in Blackboard
* Under "Assignment Submission", click the "Write Submission" button.
* Copy/paste the URL of your `report.md` file into the edit box (should be something like https<nolink>://github.com/odu-cs625-datavis/spring22-hw2-*username*/blob/master/report.md)
